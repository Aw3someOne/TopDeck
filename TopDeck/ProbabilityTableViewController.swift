//
//  ProbabilityTableViewController.swift
//  TopDeck
//
...
class ProbabilityTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return (detailItem?.categories.count)!
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ProbabilityCell", for: indexPath) as! ProbabilityTableViewCell
